class Barchart {
  ...
  constructor(state, setGlobalState) {
    ...
    this.margins = { top: 20, bottom: 20, left: 4, right: 20 };
    this.duration = 1000;
  ...
  draw(state, setGlobalState) {
    ...
    const metrics = ["Air Quality", "Air Pollution", "Emissions", "Water and Sanitation", "Heavy Metals"];
    ...
    bars
      ...
      .style("fill", d => d.metric === state.selectedMetric ? "color" : "#ccc")
